-- Convways game of life with 3D history and custom pattern loading

-- The start pattern is a simple 2D lua table.
-- You can replace the file below:
local startPattern = require("examples/patterns/68P9")

local grid = {}
local size = #startPattern
cellUpdateRate = 1/3
